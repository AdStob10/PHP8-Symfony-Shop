 ...
 */
final class Version20210527163106 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__order AS SELECT id, user_id, status, status_date, created_date, client_name, client_address FROM "order"');
        $this->addSql('DROP TABLE "order"');
        $this->addSql('CREATE TABLE "order" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, status INTEGER NOT NULL, status_date DATETIME DEFAULT NULL, created_date DATETIME DEFAULT NULL, client_name VARCHAR(150) DEFAULT NULL COLLATE BINARY, client_city VARCHAR(200) DEFAULT NULL, client_street VARCHAR(150) DEFAULT NULL, client_post_code VARCHAR(9) DEFAULT NULL, CONSTRAINT FK_F5299398A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO "order" (id, user_id, status, status_date, created_date, client_name, client_city) SELECT id, user_id, status, status_date, created_date, client_name, client_address FROM __temp__order');
        ...
        $this->addSql('CREATE TABLE order_product (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, product_id INTEGER NOT NULL, order_obj_id INTEGER NOT NULL, quantity INTEGER NOT NULL, CONSTRAINT FK_2530ADE64584665A FOREIGN KEY (product_id) REFERENCES product (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2530ADE6A5862391 FOREIGN KEY (order_obj_id) REFERENCES "order" (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_F5299398A76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__order AS SELECT id, user_id, status, created_date, status_date, client_name, client_city FROM "order"');
        $this->addSql('DROP TABLE "order"');
        $this->addSql('CREATE TABLE "order" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, status INTEGER NOT NULL, created_date DATETIME DEFAULT NULL, status_date DATETIME DEFAULT NULL, client_name VARCHAR(150) DEFAULT NULL, client_address VARCHAR(200) DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO "order" (id, user_id, status, created_date, status_date, client_name, client_address) SELECT id, user_id, status, created_date, status_date, client_name, client_city FROM __temp__order');
        $this->addSql('DROP TABLE __temp__order');
        $this->addSql('CREATE INDEX IDX_F5299398A76ED395 ON "order" (user_id)');
        $this->addSql('DROP INDEX IDX_2530ADE64584665A');
        $this->addSql('DROP INDEX IDX_2530ADE6A5862391');
