 ...
 */
final class Version20210617115009 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__order_product AS SELECT id, order_obj_id, product_id, quantity, product_name, price_product FROM order_product');
        $this->addSql('DROP TABLE order_product');
        $this->addSql('CREATE TABLE order_product (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, order_obj_id INTEGER NOT NULL, product_id INTEGER DEFAULT NULL, quantity INTEGER NOT NULL, product_name VARCHAR(150) NOT NULL COLLATE BINARY, price_product NUMERIC(10, 2) NOT NULL, CONSTRAINT FK_2530ADE64584665A FOREIGN KEY (product_id) REFERENCES product (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2530ADE6A5862391 FOREIGN KEY (order_obj_id) REFERENCES "order" (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO order_product (id, order_obj_id, product_id, quantity, product_name, price_product) SELECT id, order_obj_id, product_id, quantity, product_name, price_product FROM __temp__order_product');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_2530ADE64584665A');
        $this->addSql('DROP INDEX IDX_2530ADE6A5862391');
        $this->addSql('CREATE TEMPORARY TABLE __temp__order_product AS SELECT id, product_id, order_obj_id, quantity, product_name, price_product FROM order_product');
        $this->addSql('DROP TABLE order_product');
        $this->addSql('CREATE TABLE order_product (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, product_id INTEGER DEFAULT NULL, order_obj_id INTEGER NOT NULL, quantity INTEGER NOT NULL, product_name VARCHAR(150) NOT NULL, price_product NUMERIC(10, 2) NOT NULL)');
        $this->addSql('INSERT INTO order_product (id, product_id, order_obj_id, quantity, product_name, price_product) SELECT id, product_id, order_obj_id, quantity, product_name, price_product FROM __temp__order_product');
        $this->addSql('DROP TABLE __temp__order_product');
        $this->addSql('CREATE INDEX IDX_2530ADE64584665A ON order_product (product_id)');
        $this->addSql('CREATE INDEX IDX_2530ADE6A5862391 ON order_product (order_obj_id)');
        $this->addSql('DROP INDEX IDX_D34A04AD12469DE2');
